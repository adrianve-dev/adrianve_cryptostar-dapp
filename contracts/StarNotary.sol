...
contract StarNotary is ERC721Full {
    ...
    //found the constructor for name/symbol in the docs https://docs.openzeppelin.com/contracts/2.x/erc721
    //verified constructor here: openzeppelin-solidity/contracts/token/ERC721/ERC721Full.sol
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(owner1 == msg.sender || owner2 == msg.sender, "Neither Token owners are the sender");
        //give owner2's Star to owner1
        transferFrom(owner2, owner1, _tokenId2);
        //give owner1's Star to owner2
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == this.ownerOf(_tokenId), "Sender is not Token Owner");
